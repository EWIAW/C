...
//#include<stdbool.h>
//
//bool Solution(int* arr, int row, int col, int num)
//{
//	printf("%p\n", arr);
//	printf("%p\n", arr+1);
//
...
//	{
//		if (*(arr + brow * col + bcol) == num)
//		{
//			return true;
//		}
//		else if (*(arr + brow * col + bcol) > num)
//		{
//			bcol--;
//		}
//		else
...
//	//printf("%p\n", arr + 1);
//
//	bool ret = Solution(arr, sizeof(arr) / sizeof(arr[0]), sizeof(arr[0]) / sizeof(arr[0][0]), 7);
//	//printf("%d", ret);
//	return 0;
//}
...
void Print1(int* parr, int rows, int cols)
{
